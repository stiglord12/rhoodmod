using rhood.Content.Tiles;
using Terraria.ID;
using Terraria.ModLoader;

namespace rhood.Content.Items.Placeable
{
	public class EFNMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/EFN"), ModContent.ItemType<EFNMusicBox>(), ModContent.TileType<EFNMusicBoxTile>());
		}
public override void AddRecipes() {
			CreateRecipe()
				.AddIngredient(ItemID.MusicBox)
				.AddIngredient(ModContent.ItemType<Content.Items.BabyOil>(), 10) 
				.AddTile(TileID.WorkBenches)
				.Register();
		}
		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<EFNMusicBoxTile>(), 0);
		}
	}
}
