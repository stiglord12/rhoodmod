using rhood.Content.Items.Placeable;
...
namespace rhood.Content.Tiles
{
	...
	public class EFNMusicBoxTile : ModTile
	{
		...
		public override void MouseOver(int i, int j) {
			...
			player.cursorItemIconID = ModContent.ItemType<EFNMusicBox>();
		}
